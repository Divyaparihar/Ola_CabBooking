    ...
    <div>
      ...
      <div className="px-2 lg:px-5 py-5">
        <div className="border rounded-md">
          ...
          <div className="flex items-center border-p p-3">
            <span className="pr-5 opacity-70 text-xs font-semibold">
              DROP :{" "}
            </span>
            <span>Delhi</span>
     ...
     <div className="flex items-center justify-center w-full h-[62vh]">
      <p className="text-center w-full">
      <iframe
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d23210.035840136643!2d72.84703147443737!3d19.206776326010125!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1692206474719!5m2!1sen!2sin"
  width="100%"
  height="350"
  style={{ border: "0" }}
  allowFullScreen=""
